    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myRef.child("url").addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                change1sub = mUrl.replace(
                    "sub3",
                    PreferencesHelper().getSharedPreferences().getString("sub3", ""))
                mUrl = change1sub.replace(
                    "sub4",
                    PreferencesHelper().getSharedPreferences().getString("sub4", "")
                )
